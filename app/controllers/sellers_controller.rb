class SellersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @seller.update(seller_params)
        format.html { redirect_to @seller, notice: "Seller was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to sellers_path, notice: "Seller was successfully destroyed.", status: :see_other }
